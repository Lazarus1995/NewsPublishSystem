...
<div align="center">
    ...
    <table width="800px" height="auto" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td height="31" width="800px" colspan="2" align="left" valign="middle">&nbsp;&nbsp;&nbsp;当前位置>><s:property
                    value="#session.topName"/>>><s:property value="#session.cname"/>>>查看新闻
            </td>
        </tr>
        <tr>
            <td height="31" colspan="2" width="800px" align="left" valign="middle" background="../images/newsSort.jpg">
                <font color="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;标题：
                ...
                <div style="margin-left: 520px;margin-bottom:-30px;display: inline;"><a
                        href="index!getNewsByCid.action?topId=<s:property value="#session.topId"/>&cid=<s:property value="#session.cid"/>"><font
                        color="#FFFFFF">返回【<s:property value="#session.cname"/>】</font></a></div>
            </td>
