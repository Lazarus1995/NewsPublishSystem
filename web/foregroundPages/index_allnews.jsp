    ...
    <table width="800" height="auto" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td height="31" width="800px" colspan="2" align="left" valign="middle">&nbsp;&nbsp;&nbsp;当前位置>><s:property
                    value="#session.topName"/></td>
        </tr>
        <tr>
            <td height="31" colspan="2" align="left" valign="middle" background="../images/newsSort.jpg"><font
                    color="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;<s:property value="#session.topName"/></font></td>
        </tr>
        <tr>
                    ...
                    <s:iterator value="allnews" var="news">
                        <table width="640" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td width="250px"><a
                                        href="index!getNewsById.action?news.id=<s:property value="#news.id"/>&topId=<s:property value="#session.topId"/>">
                ...
                <table border="0" align="right" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="40" style="STYLE4">
                            <a href="index!getNewsList.action?pageNo=1&topId=<s:property value="#session.topId"/>">
                                首页</a>
                        </td>
