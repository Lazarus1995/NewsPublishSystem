    ...
    <table width="800" height="auto" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td height="31" width="800px" colspan="2" align="left" valign="middle">&nbsp;&nbsp;&nbsp;当前位置>><s:property
                    value="#session.topName"/>>><s:property value="#session.cname"/></td>
        </tr>
        <tr>
            <td height="31" colspan="2" align="left" valign="middle" background="../images/newsSort.jpg"><font
                    color="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;<s:property value="#session.cname"/></font></td>
        </tr>
        <tr>
                    ...
                    <s:iterator value="cnews" var="cn">
                        <table width="640" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td width="250px"><a
                                        href="index!getNewsById.action?news.id=<s:property value="#cn.id"/>&topId=<s:property value="#session.topId"/>">
